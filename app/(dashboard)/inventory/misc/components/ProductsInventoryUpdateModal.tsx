...
const ProductsInventoryUpdateModal: React.FC<ProductsInventoryUpdateModalProps> = ({ isModalOpen, closeModal, product }) => {
    ...
    const submit = (data: { quantity: number; cost_price: number }) => {
        ...
        console.log(getValues(), "VALS SUBMITTED")
        // Handle form submission logic here
        console.log("Form submitted successfully", data);
    }
    console.log(errors, "ERRORS")
    console.log(getValues(), "VALS")

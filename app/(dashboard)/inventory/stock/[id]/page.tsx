...
import {
  ...
  useGetStockInventoryHistory,
  useGetStockInventoryDetails,
} from "../../misc/api";
import {
...
const InventoryDetailsPage = () => {
  ...
  const {
    ...
    isFetching,
    refetch: refetchData,
  } = useGetStockInventoryDetails(product_id);
  const [selectedVariant, setSelectedVariant] = useState<
    TStockVariation | undefined
  >(
  ...
  } = useGetStockInventoryHistory(selectedVariant?.id, {
      ...
      <SelectSingleCombo
        options={
          data?.variations.map((variation) => ({
            ...
            label: `${variation.size || variation.flavour || variation.color} ${

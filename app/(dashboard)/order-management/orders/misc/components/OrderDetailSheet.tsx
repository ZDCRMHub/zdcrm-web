...
import { Book, Notepad2, UserOctagon, Printer, EmojiHappy, ProfileCircle, UserEdit } from 'iconsax-react';
import { Separator } from '@radix-ui/react-select';
import { Phone } from '@phosphor-icons/react';
import Image from 'next/image';
import {
  Input, Sheet, SheetClose, SheetContent, SheetTitle, SheetTrigger, CardHeader, Card, CardContent, Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
                    ...
                    <div className="xl:grid grid-cols-2">
                      <div className='space-y-2.5 text-[0.8rem]'>
                        <div className='flex items-center gap-x-5 gap-y-2 flex-wrap'>
                          ...
                          <p className="flex items-center gap-1 text-[#111827] font-medium">
                            <span className='text-[#687588]'>Colour:</span> 6 Red
                          </p>
                        </div>
                        <p className="text-[#111827] font-medium">

...
export default function OrdersDashboardPayments() {
  ...
  return (
    <div className='relative grid grid-rows-[max-content,1fr,max-content] gap-4 w-full md:w-[92.5%] max-w-[1792px] mx-auto pb-6 max-h-full'>

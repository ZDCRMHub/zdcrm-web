  ...
  return (
    <Card className="py-6 px-10 rounded-xl max-w-3xl">
      <header className="w-full flex items-center text-sm gap-10 font-manrope">
        <p className="w-36 font-semibold text-[#111827] ">Item1</p>
        <p className="font-dm-sans font-medium text-[#687588]">
          Branch: <span className="text-[#111827]">Zuzu Delights</span>
        </p>
      </header>
      ...
      <div className="flex gap-10">
        ...
        <div className="space-y-2 text-sm grow">
          ...
          <p className="text-[#111827] font-medium">
            <span className="text-[#687588]">Flavour:</span> Chocolate, Vanilla,
            Strawberry
          </p>
          <p className="text-[#111827] font-medium">
          ...
          <p className="text-[#111827] font-medium">
            <span className="text-[#687588]">Instructions:</span> Allergic to
            Nuts, Please make your whipped cream low.
          </p>
          <p className="text-[#111827] font-medium">
            Please ensure that the recipient knows its an anonymous order
          </p>
        </div>
      </div>
      ...
      <div className="flex justify-between ">
        <div className="flex gap-1">
          <p className="text-[#687588] italic font-light text-[0.8rem]">
            Production Cost:
          </p>
          <p className="text-[#111827] font-medium text-sm ">₦35,000</p>
        </div>
        <div className="flex font-dm-sans gap-1">
          <p className="font-medium text-[#194A7A]">Total Cost for Item 1:</p>
          <p className="font-bold text-[#194A7A]">₦90,000.00</p>
        </div>
      </div>
    </Card>
  );

...
const schema = z.object({
    ...
    orderOccasion: z.string().min(1, { message: "Order occasion is required" }),
    deliveryNote: z.string().optional(),
    deliveryMethod: z.enum(["pickup", "delivery"], { message: "Delivery method is required" }),
    ...
    return (
        <main className='px-8 2xl:px-14 max-w-[1560px]'>
            <form onSubmit={handleSubmit(onSubmit)}>
                <Accordion type="multiple" defaultValue={["customer-information", "order-information", "delivery-information", "initial-discussion"]}>
                        ...
                        <AccordionContent>
                            ...
                            <div className='grid grid-cols-2 xl:grid-cols-3 gap-10 pt-8 pb-14'>
                                ...
                                <Input
                                    ...
                                    {...register('orderOccasion')}
                                    hasError={!!errors.orderOccasion}
                                    errorMessage={errors.orderOccasion?.message as string}
                                    ...
                                    <>
                                        {
                                            field?.isEditing ? (
                                                        ...
                                                        <Controller
                                                            ...
                                                            render={({ field }) => (
                                                                <ProductsDropdown
                                                                    ...
                                                                    errorMessage={errors.items?.[index]?.productType?.message as string}
                                                                    {...field}
                                                                />
                                                            )}
                                                        />
                                                                    ...
                                                                    <Controller
                                                                        ...
                                                                        render={({ field }) => (
                                                                            <SelectSingleCombo
                                                                                ...
                                                                                errorMessage={errors.items?.[index]?.layers?.message as string}
                                                                                {...field}
                                                                            />
                                                                        )}
                                                                    />
                                                                    <Controller
                                                                        ...
                                                                        render={({ field }) => (
                                                                            <SelectSingleCombo
                                                                                ...
                                                                                errorMessage={errors.items?.[index]?.flavour?.message as string}
                                                                                {...field}
                                                                            />
                                                                        )}
                                                                    />
                                                                    <Controller
                                                                        ...
                                                                        render={({ field }) => (
                                                                            <SelectSingleCombo
                                                                                ...
                                                                                errorMessage={errors.items?.[index]?.toppings?.message as string}
                                                                                {...field}
                                                                            />
                                                                        )}
                                                                    />
                                                                    <Controller
                                                                        ...
                                                                        render={({ field }) => (
                                                                            <SelectSingleCombo
                                                                                ...
                                                                                errorMessage={errors.items?.[index]?.whippedCreamUpgrade?.message as string}
                                                                                {...field}
                                                                            />
                                                                        )}
                                                                    />
                                                                ...
                                                                <Controller
                                                                    ...
                                                                    render={({ field }) => (
                                                                        <SelectSingleCombo
                                                                            ...
                                                                            errorMessage={errors.items?.[index]?.vase?.message as string}
                                                                            {...field}
                                                                        />
                                                                    )}
                                                                />
                                                                    ...
                                                                    <Controller
                                                                        ...
                                                                        render={({ field }) => (
                                                                            <SelectSingleCombo
                                                                                ...
                                                                                errorMessage={errors.items?.[index]?.size?.message as string}
                                                                            />
                                                                        )}
                                                                    />
                                                ...
                                                :
                                                (
                                                    <article className="flex gap-6 w-full max-w-[800px] bg-white p-6 rounded-xl mb-10">

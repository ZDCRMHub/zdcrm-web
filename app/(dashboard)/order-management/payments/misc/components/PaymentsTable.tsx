...
const statusColors: Record<string, string> = {
  "Paid (Naira Transfer)":
    "bg-green-100 hover:bg-green-100 text-green-800 w-full text-center",
...
const OrderRow: React.FC<OrderRowProps> = ({ order }) => {
  return (
    <TableRow>
      ...
      <TableCell>{order.amountUSD ? `$${order.amountUSD}` : "-"}</TableCell>
  ...
  const orders: Order[] = [
    {
      ...
      category: [{ category: "C", isActive: true }],
      amount: 50000,
      amountUSD: 200,
      status: "Paid (USD Transfer)",
    ...
    },
    {
      ...
      phoneNumber: "08067556644",
      zone: "Lagos Island",
      orderItems: ["Delectable Choco cake", "Moet Chandon", "Large size teddy"],
      recipientName: "Simisola",

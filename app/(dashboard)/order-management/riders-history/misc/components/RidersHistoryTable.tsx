                ...
                <div className="inline-block min-w-full align-middle">
                    <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    <TableHead className='min-w-[200px] max-w-[500px]'>Rider&apos; Name</TableHead>
                                    <TableHead className='min-w-[150px]'>Phone Number</TableHead>
                                    <TableHead className='min-w-[230px]'>Email Address</TableHead>
                                    <TableHead className='min-w-[200px]'>Number of Orders Delivered</TableHead>
                                    <TableHead className='min-w-[150px]'>Delivery Platform</TableHead>
                                    <TableHead className='min-w-[150px]'>Total Delivery Fee</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {

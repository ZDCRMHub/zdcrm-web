...
import { ArrowDown2, Calendar, Category2 } from 'iconsax-react';

import { Button } from '@/components/ui/button';
import TabBar from '@/components/TabBar';
import { Menubar, MenubarContent, MenubarItem, MenubarMenu, MenubarSub, MenubarSubContent, MenubarSubTrigger, MenubarTrigger, RangeAndCustomDatePicker, Input, Pagination, PaginationContent, PaginationItem, PaginationLink, PaginationNext, PaginationPrevious, SelectSingleCombo, RangeDatePicker, SelectTrigger } from "@/components/ui"
...
export default function TrashedEnquiriesDashboard() {
  ...
  const [selectedStatuses, setSelectedStatuses] = useState<string | undefined>('DEL');

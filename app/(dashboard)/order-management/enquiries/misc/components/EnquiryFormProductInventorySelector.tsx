...
interface EnquiryFormProductInventorySelectorProps {
...
const EnquiryFormProductInventorySelector: React.FC<EnquiryFormProductInventorySelectorProps> = ({
    options,
    isLoadingOptions,
    isFetchingOptions,
    disabled,
...
export default EnquiryFormProductInventorySelector;

...
import { LinkButton, SuccessModal } from "@/components/ui";
    ...
    <div className="w-full md:w-[92.5%] max-w-[1792px] mx-auto p-4 space-y-9 ">
      ...
      <Card className="py-6 px-10 rounded-xl max-w-lg mt-10">
        ...
        <div className="space-y-3 text-sm">
          <p className="flex items-center gap-1 text-[#194A7A] text-base font-medium">
            <span className="text-[#687588] text-xs">Customer Name:</span> Susan
            Odere
          </p>
          <p className="flex items-center gap-1 text-[#194A7A] text-base font-medium">
            <span className="text-[#687588] text-xs">Payment Mode:</span> Bank
            Transfer
          </p>
          <p className="flex items-center gap-1 text-[#194A7A] text-base font-medium">
            <span className="text-[#687588] text-xs">Payment Status:</span> Paid
            (Naira Transfer)
          </p>
        </div>
      </Card>
      ...
      <footer className="flex items-center justify-between w-full text-sm text-gray-500 mb-8">
        <p className="text-black font-medium font-poppins">
          Enquiry Logged by: Adeayo
        </p>
        <p className="text-black font-medium font-poppins">
          Placed on: 15th June, 2024 | 6:00pm
        </p>
      </footer>

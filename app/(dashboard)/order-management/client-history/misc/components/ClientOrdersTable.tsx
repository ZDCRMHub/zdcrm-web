...
import OrderDetailSheet from "../../../misc/components/OrderDetailSheet"
...
const convertNumberToNaira = (amount: number) => {
...
const convertKebabAndSnakeToTitleCase = (str: string) => {
  return str.replace(/[-_]/g, " ").replace(/\b\w/g, (char) => char.toUpperCase())
}

const formatUniversalDate = (dateString: string) => {
  ...
  return (
    <TableRow>
      ...
      <TableCell className="min-w-max">
        ...
        >
          {ORDER_STATUS_ENUMS[order.status] || order.status}
        </Badge>
      </TableCell>

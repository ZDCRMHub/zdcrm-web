          ...
          >
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input className="" label="Delivery Note" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Input className="" label="Delivery Address" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                  ...
                  <FormItem>
                    <SelectSingleCombo
                      ...
                      options={[
                        ...
                        {
                          value: "Surulere (₦4,000)",
                          label: "Surulere (₦4,000)",
                        },
                        {
                          value: "Ayobo (₦8,000)",
                          label: "Ayobo (₦8,000)",

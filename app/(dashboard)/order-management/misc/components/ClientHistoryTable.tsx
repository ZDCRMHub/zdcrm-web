...
import { convertKebabAndSnakeToTitleCase, formatUniversalDate, maskString } from "@/utils/strings";
...
export const CLIENT_BEHAVIOUR_COLORS: Record<string, string> = {
  "Quiet": "bg-[#E5E5E5] text-black",
  "Frequent": "bg-[#FFE8FD] text-[#F914E0]",
  "First Time": "bg-[#D5EAFF] text-[#194A7A]",
  "Returning": "bg-[#D6FFC2] text-[#367917]",
};
      ...
      <TableCell className="">
        <span
            className={cn(
                ...
                CLIENT_BEHAVIOUR_COLORS[customer.client_behaviour]
            )}
        >
            {convertKebabAndSnakeToTitleCase(customer.client_behaviour)}
        </span>
      </TableCell>

      <TableCell className="">
        <div>{formatUniversalDate(new Date(customer.last_order_date))}</div>
      </TableCell>

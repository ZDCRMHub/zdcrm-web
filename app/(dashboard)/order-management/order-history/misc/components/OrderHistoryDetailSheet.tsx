...
import { Book, Notepad2, UserOctagon, Printer, UserEdit, ProfileCircle } from "iconsax-react";
            ...
            <div className="space-y-4 mt-1">
              <article className="flex border rounded-2xl p-6">
                <div className="flex flex-col gap-1.5 w-full max-w-[700px] bg-white rounded-xl">
                      ...
                      <div className="space-y-2.5 text-[0.8rem]">
                        <div className="flex items-center gap-x-5 gap-y-2 flex-wrap">
                          <p className="flex items-center gap-1 text-[#111827] font-medium">
                            <span className="text-[#687588]">Quantity:</span> 1
                            pcs
                          </p>
                          <p className="flex items-center gap-1 text-[#111827] font-medium">
                          ...
                          <p className="flex items-center gap-1 text-[#111827] font-medium">
                            <span className="text-[#687588]">Size:</span> 6
                            inches
                          </p>
                          {/* <p className="flex items-center gap-1 text-[#111827] font-medium">
                        ...
                        <p className="text-[#111827] font-medium">
                          <span className="text-[#687588]">Cake toppings:</span>{" "}
                          Fruits, chocolate & cookies
                        </p>
                      </div>

                      <div className="space-y-2.5 text-[0.8rem] content-center">
                  ...
                  <section className="flex items-center justify-end pt-1 border-t">
                    <p>Amount: ₦50,000</p>
                  </section>
                </div>
              </article>
                    ...
                    <div className="xl:grid grid-cols-2">
                      <div className="space-y-2.5 text-[0.8rem]">
                        <div className="flex items-center gap-x-5 gap-y-2 flex-wrap">
                          ...
                          <p className="flex items-center gap-1 text-[#111827] font-medium">
                            <span className="text-[#687588]">Colour:</span> 6
                            Red
                          </p>
                        </div>
                        <p className="text-[#111827] font-medium">

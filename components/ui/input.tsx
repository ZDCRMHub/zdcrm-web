    ...
    return (
      <div className={cn("flex flex-col gap-2", containerClassName)}>
        ...
        <div className="relative">
          {leftIcon && (
            <span className={cn("absolute left-4 top-[25%] cursor-pointer", leftIconContainerClass)}>{leftIcon}</span>
          )}
          <input
            ...
            {...props}
          />
          {rightIcon && <span className="absolute right-4 top-[25%] cursor-pointer">{rightIcon}</span>}
          {type === "password" && (
            <button
              type="button"
